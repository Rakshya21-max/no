...
if ($dog_id <= 0) {
    $error_message = "Please login to view details of the dog.";
} else {
    // Fetch dog details
    $stmt = $conn->prepare("
        SELECT 
...
<head>
    ...
    <title><?php echo isset($dog) ? htmlspecialchars($dog['name'] ?: 'Street Dog') : 'Not logged in'; ?> - RescueTails</title>
    ...
    <div class="frame">
        ...
        <div class="content">
            <div class="error-box">
                ...
                <a href="<?php echo $is_admin ? 'rescued-dogs.php' : 'gallery.php'; ?>" class="back-btn">
